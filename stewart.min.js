...
b.push();b.noStroke();b.fill(255,0,0);b.rotateZ(Math.PI/2);b.translate(0,-50,0);a(b,3,10);b.pop();b.push();b.noStroke();b.fill(0,255,0);b.rotateX(-Math.PI);b.translate(0,-50,0);a(b,3,10);b.pop();b.push();b.noStroke();b.fill(0,0,255);b.rotateX(-Math.PI/2);b.translate(0,-50,0);a(b,3,10);b.pop()}return function(b){d(b);b.push();this.drawBasePlate.call(this,b);b.translate(this.translation[0],this.translation[1],this.translation[2]+this.T0[2]);if(1>this.orientation.w){var c=Math.sqrt(1-this.orientation.w*
this.orientation.w);b.rotate(2*Math.acos(this.orientation.w),[this.orientation.x/c,this.orientation.y/c,this.orientation.z/c])}this.drawPlatformPlate.call(this,b);d(b);b.pop();for(c=0;c<this.B.length;c++)b.push(),b.translate(this.B[c][0],this.B[c][1],this.B[c][2]),b.noStroke(),b.fill(0),b.sphere(3),b.pop(),b.push(),b.translate(this.q[c][0],this.q[c][1],this.q[c][2]),b.noStroke(),b.fill(255,0,0),b.sphere(3),b.pop(),b.push(),b.stroke(255,0,0),b.strokeWeight(1),b.line(this.H[c][0],this.H[c][1],this.H[c][2],
this.q[c][0],this.q[c][1],this.q[c][2]),b.stroke(0),b.line(this.B[c][0],this.B[c][1],this.B[c][2],this.H[c][0],this.H[c][1],this.H[c][2]),b.pop(),this.servoRangeVisible&&(b.push(),b.translate(this.B[c][0],this.B[c][1],this.B[c][2]),b.rotateX(Math.PI/2),b.rotateY(Math.atan2(this.H[c][1]-this.B[c][1],this.H[c][0]-this.B[c][0])),b.fill("rgba(255,0,0,0.1)"),b.noStroke(),b.arc(0,0,2*this.hornLength,2*this.hornLength,this.servoRange[0],this.servoRange[1],b.PIE),b.pop())}}(),update:function(a,d){var b=this.hornLength,
c=this.rodLength,p=this.q,h=this.l,e=this.B,g=this.P,f=this.H,l=this.T0[2];this.translation=a;this.orientation=d;for(var n=0;n<e.length;n++){var m=d.rotateVector(g[n]),k=h[n],t=p[n],v=f[n],q=e[n];t[0]=a[0]+m[0];t[1]=a[1]+m[1];t[2]=a[2]+m[2]+l;k[0]=t[0]-q[0];k[1]=t[1]-q[1];k[2]=t[2]-q[2];m=k[0]*k[0]+k[1]*k[1]+k[2]*k[2]-c*c+b*b;t=2*b*k[2];var r=2*b*(this.cosBeta[n]*k[0]+this.sinBeta[n]*k[1]),u=t*t+r*r,y=Math.sqrt(1-m*m/u),w=Math.sqrt(u);k=m*t/u-r*y/w;m=m*r/u+t*y/w;v[0]=q[0]+b*m*this.cosBeta[n];v[1]=
q[1]+b*m*this.sinBeta[n];v[2]=q[2]+b*k}},getServoAngles:function(){for(var a=[],d=0;d<this.B.length;d++)a[d]=Math.asin((this.H[d][2]-this.B[d][2])/this.hornLength),isNaN(a[d])?a[d]=null:this.servoRange[0]<=a[d]&&a[d]<=this.servoRange[1]||(a[d]=null);return a}};"object"===typeof exports?(Object.defineProperty(exports,"__esModule",{value:!0}),C["default"]=C,C.Stewart=C,C.Animation=D,module.exports=C):(F.Animation=D,F.Stewart=C)})(this);