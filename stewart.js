...
(function(root) {
  ...
  Stewart.prototype = {
    ...
    initCircular: function(opts) {
      ...
      var ankerDistance = (opts.ankerDistance || 20) / baseRadius;
      ...
      this.init({
        ...
        getLegs: function() {
          ...
          for (var i = 0; i < 6; i++) {
            ...
            var phiP = phiCut - pm * ankerDistance / 2;
    ...
    initHexagonal: function(opts) {
      ...
      var ankerDistance = opts.ankerDistance || 20;
      ...
      this.init({
        ...
        getLegs: function() { // Called once at setup
          ...
          for (var i = 0; i < 6; i++) {
            ...
            platPoints.push([platMidX + baseDX * ankerDistance * pm, platMidY + baseDY * ankerDistance * pm, 0]);
